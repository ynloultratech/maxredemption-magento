...
namespace MaxRedemption\MaxRedemptionPayment\Helper;
...
class Data extends AbstractHelper
{
    ...
    const API_IDENTIFIER = 'payment/maxredemptionpayment/api_iss';
    ...
    public function getToken($orderId)
    {
        ...
        $api_iss = $this->scopeConfig->getValue(self::API_IDENTIFIER, ScopeInterface::SCOPE_STORE);
     ...
     * decode token
     */
    public function getDecodeToken($token, $api_key, $args)
    {
        return static::decode($token, $api_key, $args);
    }
